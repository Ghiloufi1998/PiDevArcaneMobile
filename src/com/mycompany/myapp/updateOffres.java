 ...
 * @author bensa
 */
public class updateOffres extends BaseForm {
OffresService th = OffresService.getInstance();


    public  updateOffres(Offres f,Resources res) {
...
//                
     ...
     //   Container x =  new Container(BoxLayout.x());
       ...
       // bindButtonSelection(myFavorite, arrow);
        ...
        this.setTitle("Modifier Offres");
        this.getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, (evt) -> {
            new HomeFormamine(res).showBack();
        });

        //Widgets
        TextField DescTF = new TextField(f.getDescription(), "Description");DescTF.setUIID("TextFieldBlack");
        TextField DesTF = new TextField(f.getDestination(), "Destination");DesTF.setUIID("TextFieldBlack");
        TextField nbPointTF = new TextField(String.valueOf(f.getNb_points_req()), "Nombre de point");nbPointTF.setUIID("TextFieldBlack");
        TextField pourcentageRedTF = new TextField(String.valueOf(f.getPourcentage_red()), "Pourcentage");pourcentageRedTF.setUIID("TextFieldBlack");
       // TextField statusTF = new TextField("", "Task's status [0 - 1]");
        ...
        submitBtn.addActionListener((evt) -> {
            if (th.updateOffres(new Offres(f.getID(),DescTF.getText(),Integer.parseInt(nbPointTF.getText()),DesTF.getText(),Integer.parseInt(pourcentageRedTF.getText()) ))) {
                Dialog.show("Success", "offre modifié", "Got it", null);
            } else {
        ...
        //end
        this.addAll(DescTF,DesTF,nbPointTF,pourcentageRedTF, submitBtn);
