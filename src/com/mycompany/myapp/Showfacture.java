 ...
 * @author bensa
 */
public class Showfacture extends BaseForm {
    //var
    FactureService ts = FactureService.getInstance();

    
    //var
   Showfacture instance;
    //private List<promotion> listprom;
     private List<Facture> lh;
...
//    private Toolbar tb;
    ...
    public Showfacture(Resources res) {
...
//        SpanLabel sp = new SpanLabel();
        List<Facture> list = ts.getInstance().getAllTasks();
        ...
        Label SLdesc = new Label("ID :"+h.getID_fac());
         Label SLadd = new Label("Montant :"+h.getMontant());
         Label SLType = new Label("Etat :"+h.getEtat());
         //Label SL = new Label("Paiement :"+h.getP().getID_PAi());
         //Label SL = new Label("Reservation :"+h.getR().getID_rev());
        ...
        Supprimer.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent evt) {
                       if (ts.deleteFacture(h.getID_fac())) {
