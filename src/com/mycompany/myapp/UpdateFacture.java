 ...
 * @author bensa
 */
public class UpdateFacture extends BaseForm {
FactureService th = FactureService.getInstance();


    public UpdateFacture(Facture f, Resources res) {
...
//                
     ...
     //   Container x =  new Container(BoxLayout.x());
       ...
       // bindButtonSelection(myFavorite, arrow);
        ...
        this.setTitle("Modifier Facture");
      ...
      Picker DateTF = new Picker();DateTF.setUIID("TextFieldBlack");
        TextField MontantTF = new TextField(String.valueOf(f.getMontant()), "Montant");MontantTF.setUIID("TextFieldBlack");
    Vector<String> vectorGender;
        ...
        ComboBox<String> gender = new ComboBox<>(vectorGender);gender.setUIID("TextFieldBlack");
       ...
       // TextField statusTF = new TextField("", "Task's status [0 - 1]");
        ...
        submitBtn.addActionListener((evt) -> {
            if (th.updateFacture(new Facture(f.getID_fac(),(Date)DateTF.getValue(),Integer.parseInt(MontantTF.getText()),gender.getSelectedItem() ))) {
                Dialog.show("Success", "Facture Updated successfully", "Got it", null);
