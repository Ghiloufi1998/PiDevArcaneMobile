 ...
 * @author bensa
 */
public class ShowPaiement extends BaseForm {
    //var
     PaiementService ts = PaiementService.getInstance();

    
    //var
   ShowPaiement instance;
   
     private List<Paiement> lh;
...
//    private Toolbar tb;
    ...
    public ShowPaiement(Resources res) {
...
//        super(BoxLayout.y());
    //   Toolbar tb = getToolbar();
	 this.setTitle("Liste de Paiement");
     // tb.addMaterialCommandToLeftBar("",FontImage.MATERIAL_ARROW_BACK, e-> showOtherForm());
//        SpanLabel sp = new SpanLabel();
        List<Paiement> list = ts.getInstance().getAllPaiement();
        ...
        Label SLdesc = new Label("ID :"+h.getID_PAi());
         Label SLadd = new Label("Montant :"+h.getMontant());
         Label SLType = new Label("Etat :"+h.getMode_Pay());
        ...
        Supprimer.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent evt) {
                       if (ts.deletePaiement(h.getID_PAi())) {
                Dialog.show("Avec succes", "Paiement supprimé", "ok", null);
            } else {
