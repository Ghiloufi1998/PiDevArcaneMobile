 ...
 * @author bensa
 */
public class HomeFormamine extends BaseForm {
 
       public HomeFormamine(Resources res) { 
...
//        ));
       ...
       // bindButtonSelection(myFavorite, arrow);
        ...
        //widgets
        Button addTaskBtn = new Button("Add Facture");
         Button addPaiementBtn = new Button("Add Paiement");
        Button showTaskBtn = new Button("Show Facture");
         Button showPaiementBtn = new Button("Show Paiement");
         Button showOffresBtn = new Button("Show Offres");
         Button AddOffresBtn = new Button("Add Offer");
        
        //actions
        addPaiementBtn.addActionListener((evt) -> {
           
            new AddPaiement(res).show();
            
        });
        showPaiementBtn.addActionListener((evt) -> {
           
            new ShowPaiement(res).show();
            
        });
         showOffresBtn.addActionListener((evt) -> {
           
            new ShowOffres(res).show();
            
        });
          AddOffresBtn.addActionListener((evt) -> {
           
            new AddOffres(res).show();
            
        });
        addTaskBtn.addActionListener((evt) -> {
           
            new Addfacture(res).show();
            
        });
        //..
        showTaskBtn.addActionListener((evt) -> {
           
            new Showfacture(res).show();
 ...
 Retour.addActionListener(new ActionListener() {
        ...
        //end
        this.addAll(addTaskBtn,showPaiementBtn,showOffresBtn,AddOffresBtn,addPaiementBtn, showTaskBtn);
