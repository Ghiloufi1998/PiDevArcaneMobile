...
import com.mycompany.entities.Weather;
...
public class HebergementService {
    ...
    public boolean addHebergement(Hebergement h) {
        ...
        //1
        String addURL = Statics.BASE_URL0 + "/abcd/new";
     ...
     public boolean updateHebergement(Hebergement h) {
        ...
        //1
        String addURL = Statics.BASE_URL0 + "/updatejsonhbr/"+h.getHebergement_id();
     ...
     public boolean deleteHebergement(int id) {
       //try {
            ...
            cr.setUrl(Statics.BASE_URL0+"/deletejsonhbr/"+id);
            cr.setPost(false);
      ...
      public void QR(Hebergement H) {
       //try {
            ...
            MultipartRequest cr = new MultipartRequest();
            cr.setUrl(Statics.BASE_URL0+"/qrjson"+H.getHebergement_id());
            cr.setPost(false);
...
//weather
    ...
    public List<Hebergement> fetchHbrs() {
        ...
        //1
        String fetchURL = Statics.BASE_URL0 + "/Allhbr";
