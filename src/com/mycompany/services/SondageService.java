...
public class SondageService {
    ...
    public boolean addSondage(Sondage t) {
        ...
        //1
        String addURL = Statics.BASE_URL + "/sondage/newJsonSond/new";
    ...
    public List<Sondage> fetchSondage() {
        ...
        //1
        String fetchURL = Statics.BASE_URL + "/sondage/AllSondage/";
    ...
    public boolean deleteSondage(int id ) {
        String DeleteURL = Statics.BASE_URL +"/sondage/deletejsonsond/"+id;
    ...
    public boolean updateSondage(Sondage sondage) {
        String url = Statics.BASE_URL +"/sondage/updatejsons/"+sondage.getSondage_id()+"?sjt="+sondage.getSujet()+"&cat="+sondage.getCatégorie();
        req.setUrl(url);
